...
namespace MaiDar.Core.Data
{
 ...
 //       {
 //           return MaiDarDataProvider.TableStructureDao.GetInsertSqlString(attributes, ConnectionString, tableName, out parms);
 //       }

 //       protected string GetUpdateSqlString(NameValueCollection attributes, string tableName, out IDataParameter[] parms)
 //       {
 //           return MaiDarDataProvider.TableStructureDao.GetUpdateSqlString(attributes, ConnectionString, tableName, out parms);
 //       }

 //       protected int GetIntResult(string sqlString)
 //       {
 //           return MaiDarDataProvider.DatabaseDao.GetIntResult(ConnectionString, sqlString);
 //       }

 //       protected string GetString(string sqlString)
 //       {
 //           return MaiDarDataProvider.DatabaseDao.GetString(ConnectionString, sqlString);
 //       }

 //       protected ArrayList GetIntArrayList(string sqlString)
 //       {
 //           return MaiDarDataProvider.DatabaseDao.GetIntArrayList(sqlString);
 //       }

 //       protected ArrayList GetIntArrayList(string connectionString, string sqlString)
 //       {
 //           return MaiDarDataProvider.DatabaseDao.GetIntArrayList(connectionString, sqlString);
 //       }

 //       protected ArrayList GetStringArrayList(string sqlString)
 //       {
 //           return MaiDarDataProvider.DatabaseDao.GetStringArrayList(sqlString);
 //       }

 //       protected ArrayList GetStringArrayList(string connectionString, string sqlString)
 //       {
 //           return MaiDarDataProvider.DatabaseDao.GetStringArrayList(connectionString, sqlString);
 //       }

 //       protected string GetSelectSqlString(string tableName, string columns, string where)
 //       {
 //           return MaiDarDataProvider.TableStructureDao.GetSelectSqlString(ConnectionString, tableName, 0, columns, where, null);
 //       }
 ...
 //       {
 //           return MaiDarDataProvider.TableStructureDao.GetSelectSqlString(connectionString, tableName, totalNum, columns, whereString, orderByString);
 //       }
 ...
 //       {
 //           return MaiDarDataProvider.TableStructureDao.GetSelectSqlString(connectionString, tableName, startNum, totalNum, columns, whereString, orderByString);
 //       }

 //       protected void ReadResultsToNameValueCollection(IDataReader rdr, NameValueCollection attributes)
 //       {
 //           MaiDarDataProvider.DatabaseDao.ReadResultsToNameValueCollection(rdr, attributes);
 //       }

 //       protected void ReadResultsToExtendedAttributes(IDataReader rdr, ExtendedAttributes attributes)
 //       {
 //           MaiDarDataProvider.DatabaseDao.ReadResultsToExtendedAttributes(rdr, attributes);
 //       }
	//}
}
