...
namespace MaiDar.Core
{
    public class AppManager
    {
        ...
        {
            return !StringUtils.EqualsIgnoreCase(Version, MaiDarDataProvider.ConfigDao.GetDatabaseVersion());
        }

        public static bool IsNeedInstall()
        {
            var isNeedInstall = !MaiDarDataProvider.ConfigDao.IsInitialized();
            if (isNeedInstall)
            {
                isNeedInstall = !MaiDarDataProvider.ConfigDao.IsInitialized();
            }
