...
namespace MaiDar.Core.AuxiliaryTable
{
    public sealed class TableStyleManager
    {
        ...
        public static PairList GetAllTableStyleInfoPairs()
        {
            ...
            { 
                ...
                {
                    var entries = MaiDarDataProvider.TableStyleDao.GetAllTableStyleInfoPairs();
        ...
        {
            var tableStyleId = MaiDarDataProvider.TableStyleDao.Insert(styleInfo, tableStyle);
            IsChanged = true;
            return tableStyleId;
        }
        ...
        {
            MaiDarDataProvider.TableStyleDao.InsertWithTaxis(styleInfo, tableStyle);
            IsChanged = true;
        }

        public static void Update(TableStyleInfo info)
        {
            MaiDarDataProvider.TableStyleDao.Update(info);
            IsChanged = true;
        }
        ...
        public static void DeleteAndInsertStyleItems(int tableStyleId, List<TableStyleItemInfo> styleItems)
        {
            ...
            MaiDarDataProvider.TableStyleDao.DeleteStyleItems(tableStyleId);
            MaiDarDataProvider.TableStyleDao.InsertStyleItems(styleItems);
        }

        public static void Delete(int relatedIdentity, string tableName, string attributeName)
        {
            MaiDarDataProvider.TableStyleDao.Delete(relatedIdentity, tableName, attributeName);
            IsChanged = true;
        }
        ...
        public static Dictionary<string, List<TableStyleInfo>> GetTableStyleInfoWithItemsDictinary(string tableName, List<int> allRelatedIdentities)
        {
            ...
            foreach (var key in entries.Keys)
            {
                ...
                {
                    styleInfo.StyleItems = MaiDarDataProvider.TableStyleDao.GetStyleItemInfoList(styleInfo.TableStyleId);
                }
        ...
        public static TableStyleInfo GetBackgroundContentTableStyleInfo(PairList entries, string tableName, string attributeName)
        {
            ...
            else if (!string.IsNullOrEmpty(attributeName))
            {
                ...
                //var tableStyleInfo = MaiDarDataProvider.TableStyleDao.GetTableStyleInfo(0, tableName, attributeName);
