    ...
    public class TableMetadataDao : DataProviderBase
    {
        ...
        public void Insert(TableMetadataInfo info)
        {
            ...
            using (var conn = GetConnection())
            {
                ...
                MaiDarDataProvider.TableCollectionDao.UpdateAttributeNum(info.AuxiliaryTableEnName);
                MaiDarDataProvider.TableCollectionDao.UpdateIsChangedAfterCreatedInDb(true, info.AuxiliaryTableEnName);
        ...
        internal void InsertWithTransaction(TableMetadataInfo info, EAuxiliaryTableType tableType, int taxis, IDbTransaction trans)
        {
            ...
            if (info.StyleInfo != null)
            {
                ...
                MaiDarDataProvider.TableStyleDao.InsertWithTransaction(info.StyleInfo, EAuxiliaryTableTypeUtils.GetTableStyle(tableType), trans);
        ...
        public void Delete(int tableMetadataId)
        {
            ...
            using (var conn = GetConnection())
            {
                ...
                MaiDarDataProvider.TableCollectionDao.UpdateAttributeNum(metadataInfo.AuxiliaryTableEnName);
                MaiDarDataProvider.TableCollectionDao.UpdateIsChangedAfterCreatedInDb(true, metadataInfo.AuxiliaryTableEnName);
                TableManager.IsChanged = true;
            }
        }
        ...
        public Hashtable GetTableEnNameAndTableMetadataInfoListHashtable()
        {
            ...
            var tableNameList = MaiDarDataProvider.TableCollectionDao.GetTableEnNameList();
        ...
        public int GetMaxTaxis(string tableEnName)
        {
            ...
            return MaiDarDataProvider.DatabaseDao.GetIntResult(sqlString, parms);
        }
        ...
        public void TaxisUp(int selectedId, string tableEnName)
        {
            ...
            if (higherId != 0)
            {
                ...
                TableManager.IsChanged = true;
                //MaiDarDataProvider.CreateAuxiliaryTableDAO().UpdateIsChangedAfterCreatedInDB(EBoolean.True, tableENName);
            }
        ...
        {
            if (MaiDarDataProvider.DatabaseDao.IsTableExists(tableEnName))
            {
        ...
        protected List<string> GetAlterDropColumnSqls(string tableEnName, string attributeName)
        {
            ...
            {
                var defaultConstraintName = MaiDarDataProvider.DatabaseDao.GetDefaultConstraintName(tableEnName, attributeName);
        ...
        public void SyncTable(string tableEnName)
        {
            ...
            var tableId = MaiDarDataProvider.DatabaseDao.GetTableId(WebConfigUtils.ConnectionString, databaseName, tableEnName);
            var columnlist = MaiDarDataProvider.DatabaseDao.GetTableColumnInfoList(WebConfigUtils.ConnectionString, databaseName, tableEnName, tableId);
            ...
            foreach (var metadataInfo in list)
            {
                ...
                foreach (var columnInfo in columnlist)
                {
                    ...
                    {
                        columnExists = true;
                        if (!MaiDarDataProvider.DatabaseDao.IsColumnEquals(metadataInfo, columnInfo))
                        {
            ...
            //添加删除字段SQL语句
            var tableType = MaiDarDataProvider.TableCollectionDao.GetTableType(tableEnName);
            ...
            MaiDarDataProvider.TableCollectionDao.UpdateIsChangedAfterCreatedInDb(false, tableEnName);
        }
