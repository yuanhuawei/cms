...
namespace MaiDarServer.BackgroundPages.WeiXin
{
    public class ModalExportCardSn : BasePageCms
    {
        ...
        public void ExportCardSncsv(string filePath, List<CardSnInfo> cardSnInfoList)
        {
            ...
            //{
            //    var userInfo = MaiDarDataProvider.UserDao.GetUserInfoByUserName(cardSnInfo.UserName);
            //    var userContactInfo = MaiDarDataProvider.UserContactDao.GetContactInfo(cardSnInfo.UserName);
