                ...
                else
                {
                    ...
                    if (cardEntitySnidList.Count > 0)
                    {
                        for (var i = 0; i < cardEntitySnidList.Count; i++)
                        {
                            ...
                            var userId = MaiDarDataProvider.UserDao.GetUserIdByEmailOrMobile(string.Empty, cardEntitySnInfo.Mobile);
                            ...
                            if (userInfo != null)
                            {
                                ...
                                //    MaiDarDataProvider.UserDao.AddCredits(userInfo.UserName, cardEntitySnInfo.Credits);
                                //}
                            }
                        }
                     }
