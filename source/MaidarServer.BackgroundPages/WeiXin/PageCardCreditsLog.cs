    ...
    public class PageCardCreditsLog : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["Delete"])) 
            {
                ...
                if (list.Count > 0)
                {
                    try
                    {
                        //MaiDarDataProvider.UserCreditsLogDao.Delete(list);
            ...
            var userNameList =MaiDarDataProvider.UserDao.GetUserNameList(Request.QueryString["mobile"],0,0,true);
            ...
            //spContents.SelectCommand = MaiDarDataProvider.UserCreditsLogDao.GetSqlString(AppManager.WeiXin.AppID, theUserNameArrayList);
        ...
        void rptContents_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                var userInfo = MaiDarDataProvider.UserDao.GetUserInfoByUserName(userName);
