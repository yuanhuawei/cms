        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
            if (IsPostBack && IsValid)
            {
                ...
                if (_cardSnid > 0)
                {
                    ...
                    userInfo = MaiDarDataProvider.UserDao.GetUserInfoByUserName(cardSnInfo!=null? cardSnInfo.UserName:string.Empty);
                }
                else
                {
                    ...
                    {
                        var userId = MaiDarDataProvider.UserDao.GetUserIdByEmailOrMobile(string.Empty, TbKeyWord.Text);
                        userInfo = MaiDarDataProvider.UserDao.GetUserInfo(userId);
                    }
                }
                ...
                //        MaiDarDataProvider.UserCreditsLogDao.Insert(userCreditsLogInfo);
                //        MaiDarDataProvider.UserDao.AddCredits(userInfo.UserName, TranslateUtils.ToInt(TbCredits.Text));
                //    }
