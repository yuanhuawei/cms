        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Body.IsQueryExists("Delete"))
            {
                ...
                try
                {
                    ...
                    {
                        MaiDarDataProvider.UserDao.Delete(userId);
                    }
            ...
            else if (Body.IsQueryExists("Lock"))
            {
                ...
                try
                {
                    MaiDarDataProvider.UserDao.Lock(userIdList);
            ...
            else if (Body.IsQueryExists("UnLock"))
            {
                ...
                try
                {
                    MaiDarDataProvider.UserDao.UnLock(userIdList);
            ...
            else
            {
                ...
                SpContents.SelectCommand = MaiDarDataProvider.UserDao.GetSelectCommand(Body.GetQueryString("Keyword"), Body.GetQueryInt("CreationDate"), Body.GetQueryInt("LastActivityDate"), true, Body.GetQueryInt("LoginCount"), Body.GetQueryString("SearchType"));
            }
