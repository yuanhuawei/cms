...
namespace MaiDarServer.BackgroundPages.Settings
{
	public class PageRole : BasePage
    {
        ...
        {
            return PageUtils.GetSettingsUrl(nameof(PageRole), null);
        }
        ...
        public void Page_Load(object sender, EventArgs e)
        {
			...
			if (Body.IsQueryExists("Delete"))
			{
				...
				try
				{
                    MaiDarDataProvider.PermissionsInRolesDao.Delete(roleName);
		...
		public DataSet GetDataSetByRoles(string[] roles)
		{
			...
			foreach (var roleName in roles)
			{
                ...
                dataRow["Description"] = MaiDarDataProvider.RoleDao.GetRoleDescription(roleName);
		...
		public void BindGrid()
		{
			try
			{
				...
				{
                    dgContents.DataSource = GetDataSetByRoles(MaiDarDataProvider.RoleDao.GetAllRoles());
				}
				else
				{
                    dgContents.DataSource = GetDataSetByRoles(MaiDarDataProvider.RoleDao.GetAllRolesByCreatorUserName(Body.AdminName));
				}
