	...
	public class ModalTableMetadataAdd : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Body.IsQueryExists("TableMetadataID"))
                {
                    ...
                    var info = MaiDarDataProvider.TableMetadataDao.GetTableMetadataInfo(tableMetadataId);
                    if (info != null)
                    {
        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
            ...
            if (Body.IsQueryExists("TableMetadataID"))
            {
                ...
                try
                {
                    MaiDarDataProvider.TableMetadataDao.Update(info);
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        MaiDarDataProvider.TableMetadataDao.Insert(info);
