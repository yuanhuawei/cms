...
namespace MaiDarServer.BackgroundPages.Settings
{
    public class ModalTableStyleAdd : BasePage
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            _styleInfo = _tableStyleId != 0 ? MaiDarDataProvider.TableStyleDao.GetTableStyleInfo(_tableStyleId) : TableStyleManager.GetTableStyleInfo(_tableStyle, _tableName, _attributeName, new List<int>{0});
