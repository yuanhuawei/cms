...
namespace MaiDarServer.BackgroundPages.Settings
{
    public class PagePublishmentSystem : BasePageCms
    {
        ...
        {
            return PageUtils.GetSettingsUrl(nameof(PagePublishmentSystem), null);
        }
        ...
        void dgContents_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (publishmentSystemInfo != null)
                {
                    ...
                    var upUrl = PageUtils.GetSettingsUrl(nameof(PagePublishmentSystem), new NameValueCollection
                    {
                        {"Up", "True" },
                    ...
                    var downUrl = PageUtils.GetSettingsUrl(nameof(PagePublishmentSystem), new NameValueCollection
                    {
                        {"Down", "True" },
                        {"PublishmentSystemID", publishmentSystemID.ToString() }
                    });
