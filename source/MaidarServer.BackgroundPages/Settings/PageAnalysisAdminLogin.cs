...
namespace MaiDarServer.BackgroundPages.Settings
{
    public class PageAnalysisAdminLogin : BasePage
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            //管理员登录量统计，按照日期
            var trackingDayDictionary = MaiDarDataProvider.LogDao.GetAdminLoginDictionaryByDate(TranslateUtils.ToDateTime(Body.GetQueryString("DateFrom")), TranslateUtils.ToDateTime(Body.GetQueryString("DateTo"), DateTime.Now), EStatictisXTypeUtils.GetValue(_xType), LogInfo.AdminLogin);

            //管理员登录量统计，按照用户名
            var adminNumDictionaryName = MaiDarDataProvider.LogDao.GetAdminLoginDictionaryByName(TranslateUtils.ToDateTime(Body.GetQueryString("DateFrom")), TranslateUtils.ToDateTime(Body.GetQueryString("DateTo"), DateTime.Now), LogInfo.AdminLogin);
