...
namespace MaiDarServer.BackgroundPages.Settings
{
    public class PageAnalysisUser : BasePage
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            //用户添加量统计
            var trackingDayDict = MaiDarDataProvider.UserDao.GetTrackingDictionary( TranslateUtils.ToDateTime(Body.GetQueryString("DateFrom")), TranslateUtils.ToDateTime(Body.GetQueryString("DateTo"), DateTime.Now), EStatictisXTypeUtils.GetValue(_xType));
