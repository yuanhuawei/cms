...
namespace MaiDarServer.BackgroundPages
{
    public class PageFindPwd : BasePage
    {
        ...
        public void Account_OnClick(object sender, EventArgs e)
        {
            ...
            {
                userName = MaiDarDataProvider.AdministratorDao.GetUserNameByMobile(account);
            }
            else if (StringUtils.IsEmail(account))
            {
                userName = MaiDarDataProvider.AdministratorDao.GetUserNameByEmail(account);
            }
            else
            {
                if (MaiDarDataProvider.AdministratorDao.IsUserNameExists(account))
                {
                    userName = account;
                }
            }
            ...
            var mobile = MaiDarDataProvider.AdministratorDao.GetMobileByUserName(account);
        ...
        public void ChangePassword_OnClick(object sender, EventArgs e)
        {
            ...
            string errorMessage;
            if (!MaiDarDataProvider.AdministratorDao.ChangePassword(userName, password, out errorMessage))
            {
