...
using MaiDarServer.CMS.Controllers.Sys.Editors;
...
$(function(){{
  ...
  $('#{0}').show();
        ...
        private static string ParseCheckBox(string attributeName, NameValueCollection formCollection, bool isAddAndNotPostBack, TableStyleInfo styleInfo)
        {
            ...
            var styleItems = styleInfo.StyleItems ?? MaiDarDataProvider.TableStyleDao.GetStyleItemInfoList(styleInfo.TableStyleId);
