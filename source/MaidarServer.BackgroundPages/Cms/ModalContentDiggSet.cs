...
namespace MaiDarServer.BackgroundPages.Cms
{
	public class ModalContentDiggSet : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
			...
			if (!IsPostBack)
			{
                var nums = MaiDarDataProvider.DiggDao.GetCount(PublishmentSystemId, _contentId);
        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MaiDarDataProvider.DiggDao.SetCount(PublishmentSystemId, _contentId, goodNum, badNum);
