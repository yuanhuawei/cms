                    ...
                    foreach (var nodeId in _idsDictionary.Keys)
                    {
                        ...
                        if (!_isDeleteFromTrash)
                        {
                            ...
                            if (contentIdList.Count == 1)
                            {
                                ...
                                var contentTitle = MaiDarDataProvider.ContentDao.GetValue(tableName, contentId, ContentAttribute.Title);
                            ...
                            {
                                var targetContentIdList = MaiDarDataProvider.ContentDao.GetReferenceIdList(table.TableEnName, contentIdList);
