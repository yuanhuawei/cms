...
namespace MaiDarServer.BackgroundPages.Cms
{
    public class ModalTableStyleAdd : BasePageCms
    {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            _styleInfo = _tableStyleId != 0 ? MaiDarDataProvider.TableStyleDao.GetTableStyleInfo(_tableStyleId) : TableStyleManager.GetTableStyleInfo(_tableStyle, _tableName, _attributeName, _relatedIdentities);
            ...
            if (!IsPostBack)
            {
                ...
                var styleItems = _styleInfo.StyleItems ?? MaiDarDataProvider.TableStyleDao.GetStyleItemInfoList(_styleInfo.TableStyleId);
        ...
        public void SetCount_OnClick(object sender, EventArgs e)
        {
            if (Page.IsPostBack)
            {
                ...
                if (count != 0)
                {
                    ...
                    {
                        styleItems = MaiDarDataProvider.TableStyleDao.GetStyleItemInfoList(_styleInfo.TableStyleId);
                    }
