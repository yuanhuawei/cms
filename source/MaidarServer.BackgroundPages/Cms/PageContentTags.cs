	...
	public class PageContentTags : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Body.IsQueryExists("Delete"))
            {
                ...
                try
                {
                    var contentIDArrayList = MaiDarDataProvider.TagDao.GetContentIdListByTag(tagName, PublishmentSystemId);
                    ...
                    MaiDarDataProvider.TagDao.DeleteTag(tagName, PublishmentSystemId);
        ...
        private void BindGrid()
        {
            try
            {
                ...
                dgContents.DataSource = MaiDarDataProvider.TagDao.GetTagInfoList(PublishmentSystemId, 0, true, 0);
