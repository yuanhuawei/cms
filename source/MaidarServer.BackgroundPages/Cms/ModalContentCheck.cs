        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                foreach (var nodeId in _idsDictionary.Keys)
                {
                    ...
                    {
                        var title = MaiDarDataProvider.ContentDao.GetValue(tableName, contentId, ContentAttribute.Title);
            ...
            else
            {
                try
                {
                    ...
                    foreach (var nodeId in idsDictionaryToCheck.Keys)
                    {
                        ...
                        MaiDarDataProvider.ContentDao.UpdateIsChecked(tableName, PublishmentSystemId, nodeId, contentIdList, translateNodeId, true, Body.AdminName, isChecked, checkedLevel, tbCheckReasons.Text);
