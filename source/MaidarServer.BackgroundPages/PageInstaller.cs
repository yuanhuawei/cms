...
Disallow: /home/");
        ...
        protected void btnStep3_Click(object sender, EventArgs e)
        {
            ...
            if (PhSql1.Visible)
            {
                ...
                else
                {
                    ...
                    isConnectValid = MaiDarDataProvider.DatabaseDao.ConnectToServer(isMySql, connectionStringWithoutDatabaseName, out databaseNameList, out errorMessage);
                }
        ...
        private bool InstallDatabase(out string errorMessage)
        {
            ...
            try
            {
                ...
                MaiDarDataProvider.DatabaseDao.Install(errorBuilder);

                MaiDarDataProvider.ConfigDao.InitializeConfig();
                MaiDarDataProvider.ConfigDao.InitializeUserRole(TbAdminName.Text, TbAdminPassword.Text);
