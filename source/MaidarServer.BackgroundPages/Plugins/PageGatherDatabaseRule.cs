...
namespace MaiDarServer.BackgroundPages.Plugins
{
	public class PageGatherDatabaseRule : BasePageCms
    {
        ...
        {
            return PageUtils.GetPluginsUrl(nameof(PageGatherDatabaseRule), new NameValueCollection
            {
        ...
        public string GetAutoCreateClickString()
        {
            return
                PageUtils.GetRedirectStringWithCheckBoxValueAndAlert(
                    PageUtils.GetPluginsUrl(nameof(PageGatherDatabaseRule), new NameValueCollection
                    {
                        {"PublishmentSystemID", PublishmentSystemId.ToString()},
                        {"Auto", true.ToString()}
