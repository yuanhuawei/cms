...
namespace MaiDarServer.BackgroundPages.Plugins
{
    public class PageGatherRule : BasePageCms
    {
        ...
        {
            return PageUtils.GetPluginsUrl(nameof(PageGatherRule), new NameValueCollection
            {
        ...
        public string GetAutoCreateClickString()
        {
            return PageUtils.GetRedirectStringWithCheckBoxValueAndAlert(
                PageUtils.GetPluginsUrl(nameof(PageGatherRule), new NameValueCollection
                {
                    {"PublishmentSystemID", PublishmentSystemId.ToString()},
                    {"Auto", true.ToString()}
        ...
        void dgContents_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                var urlCopy = PageUtils.GetPluginsUrl(nameof(PageGatherRule), new NameValueCollection
                {
                    {"PublishmentSystemID", PublishmentSystemId.ToString()},
                ...
                var urlDelete = PageUtils.GetPluginsUrl(nameof(PageGatherRule), new NameValueCollection
                {
                    {"PublishmentSystemID", PublishmentSystemId.ToString()},
                    {"GatherRuleName", gatherRuleInfo.GatherRuleName},
