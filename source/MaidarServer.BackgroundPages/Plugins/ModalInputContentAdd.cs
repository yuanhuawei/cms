...
namespace MaiDarServer.BackgroundPages.Plugins
{
	public class ModalInputContentAdd : BasePageCms
    {
        ...
        {
            return PageUtils.GetOpenWindowString("添加信息", PageUtils.GetPluginsUrl(nameof(ModalInputContentAdd), new NameValueCollection
            {
        ...
        {
            return PageUtils.GetOpenWindowString("修改信息", PageUtils.GetPluginsUrl(nameof(ModalInputContentAdd), new NameValueCollection
            {
                {"PublishmentSystemID", publishmentSystemId.ToString()},
                {"InputID", inputId.ToString()},
