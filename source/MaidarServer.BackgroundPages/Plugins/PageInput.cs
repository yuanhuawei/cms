...
namespace MaiDarServer.BackgroundPages.Plugins
{
	public class PageInput : BasePageCms
    {
        ...
        {
            return PageUtils.GetPluginsUrl(nameof(PageInput), new NameValueCollection
            {
...
");
        ...
        private void DgContents_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            var urlUp = PageUtils.GetPluginsUrl(nameof(PageInput), new NameValueCollection
            {
                {"PublishmentSystemID", PublishmentSystemId.ToString()},
            ...
            var urlDown = PageUtils.GetPluginsUrl(nameof(PageInput), new NameValueCollection
            {
                {"PublishmentSystemID", PublishmentSystemId.ToString()},
                {"InputID", inputId.ToString()},
                {"Down", true.ToString()}
            ...
            var urlDelete = PageUtils.GetPluginsUrl(nameof(PageInput), new NameValueCollection
            {
                {"PublishmentSystemID", PublishmentSystemId.ToString()},
                {"InputID", inputId.ToString()},
