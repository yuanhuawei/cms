	...
	public class ModalGatherTest : BasePageCms
    {
		...
		public void GetContent_Click(object sender, EventArgs e)
		{
            ...
            foreach (var styleInfo in styleInfoList)
            {
                ...
                else if (StringUtils.EqualsIgnoreCase(BackgroundContentAttribute.ImageUrl, styleInfo.AttributeName) || InputTypeUtils.Equals(styleInfo.InputType, InputType.Image))
                {
