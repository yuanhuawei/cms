...
namespace MaiDarServer.BackgroundPages.Plugins
{
	public class PageSeoMetaList : BasePageCms
    {
        ...
        {
            return PageUtils.GetPluginsUrl(nameof(PageSeoMetaList), new NameValueCollection
            {
        ...
        void dgContents_ItemDataBound(object sender, DataGridItemEventArgs e)
		{
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (!isDefault)
                {
                    var urlDefault = PageUtils.GetPluginsUrl(nameof(PageSeoMetaList), new NameValueCollection
                    {
                        {"PublishmentSystemID", PublishmentSystemId.ToString() },
                ...
                var urlDelete = PageUtils.GetPluginsUrl(nameof(PageSeoMetaList), new NameValueCollection
                {
                    {"PublishmentSystemID", PublishmentSystemId.ToString()},
                    {"SeoMetaID", seoMetaID.ToString()},
