...
namespace MaiDarServer.BackgroundPages.Plugins
{
	public class PageGatherFileRule : BasePageCms
    {
        ...
        {
            return PageUtils.GetPluginsUrl(nameof(PageGatherFileRule), new NameValueCollection
            {
        ...
        public string GetAutoCreateClickString()
        {
            return PageUtils.GetRedirectStringWithCheckBoxValueAndAlert(
                PageUtils.GetPluginsUrl(nameof(PageGatherFileRule), new NameValueCollection
                {
                    {"PublishmentSystemID", PublishmentSystemId.ToString()},
                    {"Auto", true.ToString()}
