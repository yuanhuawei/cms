...
namespace MaiDarServer.BackgroundPages.Plugins
{
    public class PageContentPhotoUpload : BasePageCms
    {
        ...
        public static string GetRedirectUrl(int publishmentSystemId, int channelId, int contentId, string returnUrl)
        {
            return PageUtils.GetPluginsUrl(nameof(PageContentPhotoUpload), new NameValueCollection
            {
        ...
        public void Page_Load(object sender, EventArgs e)
        {
            ...
            PageUtils.CheckRequestParameter("ReturnUrl");
...
";
        ...
        {
            return
                $@"max-width:{PublishmentSystemInfo.Additional.PhotoSmallWidth}; max-height={PublishmentSystemInfo.Additional.PhotoSmallWidth}";
        }
        ...
        public override void Submit_OnClick(object sender, EventArgs e)
        {
            ...
            var tableName = NodeManager.GetTableName(PublishmentSystemInfo, _channelId);
            MaiDarDataProvider.ContentDao.UpdatePhotos(tableName, _contentId, count);
