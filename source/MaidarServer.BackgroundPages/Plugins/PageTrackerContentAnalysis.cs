...
namespace MaiDarServer.BackgroundPages.Plugins
{
	public class PageTrackerContentAnalysis : BasePageCms
    {
		...
		public void Page_Load(object sender, EventArgs e)
        {
            ...
            spContents.SelectCommand = MaiDarDataProvider.ContentDao.GetSelectCommend(tableName, nodeIdList, ETriState.True);
            spContents.SortField = MaiDarDataProvider.ContentDao.GetSortFieldName();
		...
		{
            PageUtils.Redirect(PageUtils.GetPluginsUrl(nameof(PageTrackerContentAnalysis), new NameValueCollection
            {
