...
namespace MaiDarServer.CMS.Provider
{
    public class InputContentDao : DataProviderBase
    {
        ...
        public int Insert(InputContentInfo info)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(info.GetExtendedAttributes(), TableName, out parms);
        ...
        public void Update(InputContentInfo info)
        {
            info.BeforeExecuteNonQuery();
            IDataParameter[] parms;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(info.GetExtendedAttributes(), TableName, out parms);
        ...
        {
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(TableName, SqlUtils.Asterisk, whereString);
        ...
        {
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(TableName, totalNum, SqlUtils.Asterisk, whereString, orderByString);
        ...
        public string GetSelectStringOfContentId(int inputId, string whereString)
        {
            ...
            return MaiDarDataProvider.DatabaseDao.GetSelectSqlString(TableName, "ID, Taxis", where);
        }
        ...
        public string GetSelectSqlStringWithChecked(int publishmentSystemId, int inputId, bool isReplyExists, bool isReply, int startNum, int totalNum, string whereString, string orderByString, LowerNameValueCollection others)
        {
            ...
            return MaiDarDataProvider.DatabaseDao.GetSelectSqlString(TableName, startNum, totalNum, SqlUtils.Asterisk, sqlWhereString, orderByString);
        }
