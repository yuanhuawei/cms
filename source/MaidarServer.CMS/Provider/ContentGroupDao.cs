...
namespace MaiDarServer.CMS.Provider
{
    public class ContentGroupDao : DataProviderBase
    {
        ...
        public void Insert(ContentGroupInfo contentGroup)
        {
			...
			{
				GetParameter(ParmGroupName, DataType.NVarChar, 255, contentGroup.ContentGroupName),
				...
				GetParameter(ParmDescription, DataType.NText, contentGroup.Description)
			};
        ...
        public void Delete(string groupName, int publishmentSystemId)
        {
			...
			{
				GetParameter(ParmGroupName, DataType.NVarChar, 255, groupName),
        ...
        private int GetTaxis(int publishmentSystemId, string groupName)
        {
            ...
            return MaiDarDataProvider.DatabaseDao.GetIntResult(sqlString, selectParms);
        }
