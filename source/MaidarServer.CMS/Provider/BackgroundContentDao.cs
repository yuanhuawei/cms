	...
	public class BackgroundContentDao : DataProviderBase
	{
        public List<KeyValuePair<int, int>> GetCountArrayListUnChecked(bool isSystemAdministrator, string administratorName, List<int> publishmentSystemIdList, List<int> owningNodeIdList, string tableName)
        {
            ...
            foreach (int publishmentSystemId in publishmentSystemIdArrayList)
            {
                ...
                var count = MaiDarDataProvider.DatabaseDao.GetIntResult(sqlString);
                if (count > 0)
                {
        ...
        public string GetStlWhereString(int publishmentSystemId, string tableName, string group, string groupNot, string tags, bool isImageExists, bool isImage, bool isVideoExists, bool isVideo, bool isFileExists, bool isFile, bool isTopExists, bool isTop, bool isRecommendExists, bool isRecommend, bool isHotExists, bool isHot, bool isColorExists, bool isColor, string where, bool isCreateSearchDuplicate)
        {
            ...
            if (!string.IsNullOrEmpty(tags))
            {
                ...
                var contentIdArrayList = MaiDarDataProvider.TagDao.GetContentIdListByTagCollection(tagCollection, publishmentSystemId);
            ...
            {
                var sqlString = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(tableName, "MIN(ID)", whereBuilder + " GROUP BY Title");
