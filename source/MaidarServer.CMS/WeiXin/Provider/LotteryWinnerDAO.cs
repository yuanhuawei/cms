...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    ...
    {
        public override string TableName => "wx_LotteryWinner";
        ...
        public int Insert(LotteryWinnerInfo winnerInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(winnerInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(winnerInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public LotteryWinnerInfo GetWinnerInfo(int publishmentSystemId, int lotteryId, string cookieSn, string wxOpenId, string userName)
        {
            ...
            if (winnerInfo == null)
            {
                ...
                sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, SqlUtils.Asterisk, sqlWhere, null);
