...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class CardSignLogDao : DataProviderBase
    {
        ...
        public int Insert(CardSignLogInfo cardSignLogInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(cardSignLogInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(cardSignLogInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public List<DateTime> GetSignDateList(int publishmentSystemId, string userName)
        {
            ...
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, CardSignLogAttribute.SignDate, sqlWhere, sqlOrder);
