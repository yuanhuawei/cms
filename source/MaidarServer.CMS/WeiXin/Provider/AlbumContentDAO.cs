...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class AlbumContentDao : DataProviderBase
    {
        ...
        public int Insert(AlbumContentInfo albumContentInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(albumContentInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(albumContentInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public string GetTitle(int albumContentId)
        {
            ...
            string sqlWhere = $"WHERE ID = {albumContentId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, AlbumContentAttribute.Title, sqlWhere, null);
