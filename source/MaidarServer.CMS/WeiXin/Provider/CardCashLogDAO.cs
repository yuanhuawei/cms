...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    ...
    {
        public override string TableName => "wx_CardCashLog";
        ...
        public int Insert(CardCashLogInfo cardCashLogInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(cardCashLogInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(cardCashLogInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public List<CardCashLogInfo> GetCardCashLogInfoList(int cardId,int cardSnid,string userName,string startDate,string endDate)
        {
            ...
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, SqlUtils.Asterisk, sqlWhere, sqlOrder);
