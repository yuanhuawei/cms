...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    ...
    {
        public override string TableName => "wx_Lottery";
        ...
        public int Insert(LotteryInfo lotteryInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(lotteryInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(lotteryInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public List<int> GetLotteryIdList(int publishmentSystemId, ELotteryType lotteryType)
        {
            ...
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, LotteryAttribute.Id, sqlWhere, null);
        ...
        public int GetKeywordId(int lotteryId)
        {
            ...
            string sqlWhere = $"WHERE ID = {lotteryId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, LotteryAttribute.KeywordId, sqlWhere, null);
