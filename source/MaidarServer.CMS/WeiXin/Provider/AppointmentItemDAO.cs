...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    ...
    {
        public override string TableName => "wx_AppointmentItem";
        ...
        public int Insert(AppointmentItemInfo appointmentItemInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(appointmentItemInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(appointmentItemInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public int GetItemId(int publishmentSystemId, int appointmentId)
        {
            ...
            string sqlWhere =
                $"WHERE {AppointmentItemAttribute.PublishmentSystemId} = {publishmentSystemId} AND {AppointmentItemAttribute.AppointmentId} = {appointmentId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, AppointmentItemAttribute.Id, sqlWhere, null);
        ...
        public string GetTitle(int appointmentItemId)
        {
            ...
            string sqlWhere = $"WHERE ID = {appointmentItemId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, AppointmentItemAttribute.Title, sqlWhere, null);
