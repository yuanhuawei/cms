...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class VoteDao : DataProviderBase
    {
        ...
        public int Insert(VoteInfo voteInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(voteInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(voteInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public string GetTitle(int voteId)
        {
            ...
            string sqlWhere = $"WHERE ID = {voteId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, VoteAttribute.Title, sqlWhere, null);
