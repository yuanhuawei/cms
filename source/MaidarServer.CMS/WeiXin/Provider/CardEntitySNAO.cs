...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class CardEntitySnDao : DataProviderBase
    {
        ...
        public int Insert(CardEntitySnInfo cardEntitySnInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(cardEntitySnInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(cardEntitySnInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
