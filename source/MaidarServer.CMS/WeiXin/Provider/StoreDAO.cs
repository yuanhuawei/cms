...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class StoreDao : DataProviderBase
    {
        ...
        public int Insert(StoreInfo storeInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(storeInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(storeInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public string GetTitle(int storeId)
        {
            ...
            string sqlWhere = $"WHERE ID = {storeId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, StoreAttribute.Title, sqlWhere, null);
