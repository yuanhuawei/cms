...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    ...
    {
        public override string TableName => "wx_Collect";
        ...
        public int Insert(CollectInfo collectInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(collectInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(collectInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public string GetTitle(int collectId)
        {
            ...
            string sqlWhere = $"WHERE ID = {collectId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, CollectAttribute.Title, sqlWhere, null);
