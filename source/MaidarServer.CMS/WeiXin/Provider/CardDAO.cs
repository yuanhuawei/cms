...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class CardDao : DataProviderBase
    {
        ...
        public int Insert(CardInfo cardInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(cardInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(cardInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public string GetTitle(int cardId)
        {
            ...
            string sqlWhere = $"WHERE ID = {cardId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, CardAttribute.Title, sqlWhere, null);
