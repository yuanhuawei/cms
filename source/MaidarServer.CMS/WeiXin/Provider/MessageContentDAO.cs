...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    ...
    {
        public override string TableName => "wx_MessageContent";
        ...
        public bool AddLikeCount(int contentId, string cookieSn, string wxOpenId)
        {
            ...
            if (contentId > 0)
            {
                ...
                var cookieSnList = TranslateUtils.StringCollectionToStringList(MaiDarDataProvider.DatabaseDao.GetString(sqlString));
        ...
        public List<MessageContentInfo> GetContentInfoList(int messageId, int startNum, int totalNum)
        {
            ...
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, startNum, totalNum, SqlUtils.Asterisk, sqlWhere, "ORDER BY ID DESC");
