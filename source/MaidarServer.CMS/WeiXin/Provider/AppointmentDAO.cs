...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class AppointmentDao : DataProviderBase
    {
        ...
        public int Insert(AppointmentInfo appointmentInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(appointmentInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(appointmentInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        private List<int> GetAppointmentIdList(int publishmentSystemId)
        {
            ...
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, AppointmentAttribute.Id, sqlWhere, null);
        ...
        public string GetTitle(int appointmentId)
        {
            ...
            string sqlWhere = $"WHERE ID = {appointmentId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, AppointmentAttribute.Title, sqlWhere, null);
