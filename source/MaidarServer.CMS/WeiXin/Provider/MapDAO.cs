...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class MapDao : DataProviderBase
    {
        ...
        public int Insert(MapInfo mapInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(mapInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(mapInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public string GetTitle(int mapId)
        {
            ...
            string sqlWhere = $"WHERE ID = {mapId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, MapAttribute.Title, sqlWhere, null);
