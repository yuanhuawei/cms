...
using ECountType = MaiDarServer.CMS.WeiXin.Model.Enumerations.ECountType;
using ECountTypeUtils = MaiDarServer.CMS.WeiXin.Model.Enumerations.ECountTypeUtils;
