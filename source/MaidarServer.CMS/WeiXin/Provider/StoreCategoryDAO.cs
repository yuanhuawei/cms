...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class StoreCategoryDao : DataProviderBase
    {
        ...
        public int Insert(StoreCategoryInfo storeCategoryInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(storeCategoryInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public Dictionary<string, int> GetStoreCategoryDictionary(int publishmentSystemId)
        {
            ...
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(TableName, StoreCategoryAttribute.CategoryName + "," + StoreCategoryAttribute.Taxis, sqlWhere);
        ...
        public List<StoreCategoryInfo> GetStoreCategoryInfoList(int publishmentSystemId, int parentId)
        {
            ...
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, SqlUtils.Asterisk, builder.ToString(), "ORDER BY Taxis");
        ...
        public string GetCategoryName(int storeId)
        {
            ...
            string sqlWhere = $"WHERE ID = {storeId}";
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(ConnectionString, TableName, 0, StoreCategoryAttribute.CategoryName, sqlWhere, null);
