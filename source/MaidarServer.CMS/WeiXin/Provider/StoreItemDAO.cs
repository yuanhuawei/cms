...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    ...
    {
        public override string TableName => "wx_StoreItem";
        ...
        public int Insert(StoreItemInfo storeItemInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(storeItemInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(storeItemInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
