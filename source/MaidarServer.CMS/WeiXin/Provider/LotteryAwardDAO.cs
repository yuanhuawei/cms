...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    ...
    {
        public override string TableName => "wx_LotteryAward";
        ...
        public int Insert(LotteryAwardInfo awardInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(awardInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(awardInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        public Dictionary<string, int> GetLotteryAwardDictionary(int lotteryId)
        {
            ...
            var sqlSelect = MaiDarDataProvider.DatabaseDao.GetSelectSqlString(TableName, LotteryAwardAttribute.Title + "," + LotteryAwardAttribute.TotalNum, sqlWhere);
