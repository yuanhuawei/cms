...
namespace MaiDarServer.CMS.WeiXin.Provider
{
    public class SearchNavigationDao : DataProviderBase
    {
        ...
        public int Insert(SearchNavigationInfo searchNavigationInfo)
        {
            ...
            var sqlInsert = MaiDarDataProvider.DatabaseDao.GetInsertSqlString(searchNavigationInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
        ...
        {
            IDataParameter[] parms = null;
            var sqlUpdate = MaiDarDataProvider.DatabaseDao.GetUpdateSqlString(searchNavigationInfo.ToNameValueCollection(), ConnectionString, TableName, out parms);
