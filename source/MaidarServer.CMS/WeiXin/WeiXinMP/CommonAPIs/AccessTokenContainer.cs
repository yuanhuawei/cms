...
namespace MaiDarServer.CMS.WeiXin.WeiXinMP.CommonAPIs
{
    ...
    public class AccessTokenContainer
    {
        ...
        /// <summary>
        /// 注册站点凭证信息，此操作只是注册，不会马上获取Token，并将清空之前的Token，
        /// </summary>
        ...
        /// <summary>
        /// 使用完整的站点凭证获取Token，如果不存在将自动注册
        /// </summary>
        /// <param name="appId"></param>
        /// <param name="appSecret"></param>
        /// <param name="getNewToken"></param>
        /// <returns></returns>
        public static string TryGetToken(string appId, string appSecret, bool getNewToken = true)
        {
        ...
        /// <returns></returns>
        public static string GetToken(string appId, bool getNewToken = true)
        {
        ...
        /// <param name="getNewToken">是否强制重新获取新的Token</param>
        /// <returns></returns>
        public static AccessTokenResult GetTokenResult(string appId, bool getNewToken = true)
        {
