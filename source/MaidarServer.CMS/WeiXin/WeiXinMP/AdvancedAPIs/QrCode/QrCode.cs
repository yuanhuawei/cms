using System.IO;
using MaiDarServer.CMS.WeiXin.WeiXinMP.CommonAPIs;

namespace MaiDarServer.CMS.WeiXin.WeiXinMP.AdvancedAPIs.QrCode
{
    ...
    public static class QrCode
    {
        ...
        {
            HttpUtility.Get.Download($"https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket={ticket}", stream);
        }
    }
}
