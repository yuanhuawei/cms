...
namespace MaiDarServer.CMS.Core.User
{
	public class CheckManager
	{
        ...
        public static List<KeyValuePair<int, int>> GetUserCountListUnChecked(string administratorName)
        {
            ...
            var tableEnNameList = MaiDarDataProvider.TableCollectionDao.GetTableEnNameListCreatedInDbByAuxiliaryTableType(EAuxiliaryTableType.BackgroundContent);
