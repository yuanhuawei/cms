...
namespace MaiDarServer.CMS.Core.Permissions
{
                ...
                if (_permissionList == null)
                {
                    if (!string.IsNullOrEmpty(UserName) && !string.Equals(UserName, AdminManager.AnonymousUserName))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                _permissionList = MaiDarDataProvider.PermissionsInRolesDao.GetGeneralPermissionList(Roles);
                            }
            ...
            get
            {
                if (_roles == null)
                {
                    if (!string.IsNullOrEmpty(UserName) && !string.Equals(UserName, AdminManager.AnonymousUserName))
                    {
                        ...
                        {
                            _roles = MaiDarDataProvider.AdministratorsInRolesDao.GetRolesForUser(UserName);
