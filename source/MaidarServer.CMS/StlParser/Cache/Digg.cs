    ...
    public class Digg
    {
        ...
        public static int[] GetCount(int publishmentSystemId, int relatedIdentity)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = MaiDarDataProvider.DiggDao.GetCount(publishmentSystemId, relatedIdentity);
        ...
        public static List<int> GetRelatedIdentityListByTotal(int publishmentSystemId)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = MaiDarDataProvider.DiggDao.GetRelatedIdentityListByTotal(publishmentSystemId);
                    StlCacheUtils.SetCache(cacheKey, retval);
                }
            }
