    ...
    public class Tag
    {
        ...
        public static List<int> GetContentIdListByTagCollection(StringCollection tagCollection, int publishmentSystemId)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = MaiDarDataProvider.TagDao.GetContentIdListByTagCollection(tagCollection, publishmentSystemId);
        ...
        public static List<TagInfo> GetTagInfoList(int publishmentSystemId, int contentId, bool isOrderByCount, int totalNum)
        {
            ...
            lock (LockObject)
            {
                ...
                if (retval == null)
                {
                    retval = MaiDarDataProvider.TagDao.GetTagInfoList(publishmentSystemId, contentId, isOrderByCount, totalNum);
                    StlCacheUtils.SetCache(cacheKey, retval);
                }
            }
