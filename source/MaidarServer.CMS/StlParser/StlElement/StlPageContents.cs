...
namespace MaiDarServer.CMS.StlParser.StlElement
{
    ...
    public class StlPageContents : StlContents
    {
        ...
        public int GetPageCount(out int totalNum)
        {
            ...
            try
            {
                //totalNum = MaiDarDataProvider.DatabaseDao.GetPageTotalCount(SqlString);
        ...
        public string Parse(int totalNum, int currentPageIndex, int pageCount, bool isStatic)
        {
            ...
            try
            {
                if (_node != null)
                {
                    ...
                    {
                        //var pageSqlString = MaiDarDataProvider.DatabaseDao.GetPageSqlString(SqlString, ListInfo.OrderByString, totalNum, ListInfo.PageNum, currentPageIndex);
                        ...
                        var datasource = MaiDarDataProvider.DatabaseDao.GetDataSource(pageSqlString);
