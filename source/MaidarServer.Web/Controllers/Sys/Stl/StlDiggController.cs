...
namespace MaiDarServer.API.Controllers.Sys.Stl
{
    ...
    public class StlDiggController : ApiController
    {
        ...
        public void Main(int publishmentSystemId)
        {
            ...
            if (isDigg)
            {
                MaiDarDataProvider.DiggDao.AddCount(publishmentSystemId, relatedIdentity, isGood);
            }

            var counts = MaiDarDataProvider.DiggDao.GetCount(publishmentSystemId, relatedIdentity);
